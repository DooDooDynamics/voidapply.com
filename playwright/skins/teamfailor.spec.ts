...
test('skin teamfailor submits and lands on dev-null rejection', async ({ page }) => {
  await page.goto('/debug/skin/teamfailor')
  await page.waitForLoadState('networkidle')
  await setDebugRejection(page, 'dev-null')
  // Teamfailor has a ~3s countdown before the form unlocks.
  await fillSkinForm(page, 'teamfailor')
